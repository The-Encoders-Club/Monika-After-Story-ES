...
init -3 python:
    ...
    class MASHair(MASSpriteFallbackBase):
        ...
        _m1_sprite0x2dchart__MHM_KEYS_NUM = store.mas_sprites._genLK(
        ...
        def _prepare_hl_data(cls, hl_data, use_nli=False):
            ...
            if use_nli:
                return (cls._m1_sprite0x2dchart__MHM_KEYS_NUM, hl_def, hl_mapping)
        ...
        def hl_keys(self):
            ...
            """
            return (
                self._m1_sprite0x2dchart__MHM_KEYS_NUM
                if self.use_numeric_layer_ids 
                else self._m1_sprite0x2dchart__MHM_KEYS
            )
        ...
        def hl_keys_c(cls, use_nli=False):
            ...
            RETURNS: tuple of hl keys
            """
            return cls._m1_sprite0x2dchart__MHM_KEYS_NUM if use_nli else cls._m1_sprite0x2dchart__MHM_KEYS
