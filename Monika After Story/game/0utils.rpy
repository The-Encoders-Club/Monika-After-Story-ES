...
python early in mas_logging:
    ...
    LOAD_TRY = "Intentando cargar '{0}'..."
    LOAD_SUCC = "'{0}' cargado con éxito."
    LOAD_FAILED = "Carga fallida."

    JSON_LOAD_FAILED = "Error al cargar json en '{0}'."
    FILE_LOAD_FAILED = "Error al cargar el archivo en '{0}'. | {1}"
    NAME_BAD = "el nombre debe ser único."
    ...
    try:
        ...
        raise Exception("No se ha podido crear la carpeta de registro porque: {}".format(e))
...
python early in mas_utils:
    ...
    def report_deprecation(
        ...
        use_instead="",
        should_raise=False,
        deprecated_msg_fmt="{deprecated} está obsoleto.",
        use_instead_msg_fmt="Utilice '{use_instead}' en lugar de."
    ):
        """
        ...
        def open(self):  
            ...
            try:
                ...
                try:
                    ...
                    self.write("Plataforma desconocida.")
